...
# Start Celery worker
celery -A django_core worker --loglevel=info -c 4 2>&1 &

# Start Celery beat scheduler
celery -A django_core beat --loglevel=info --scheduler django_celery_beat.schedulers:DatabaseScheduler 2>&1 &
