    ...
    <AnimatedPage>
      <div className="mx-2 mb-4">
        ...
        <p className="mb-4 mx-auto text-center">
          A continuación están las preguntas y soluciones más frecuentes:
        </p>
        ...
        <div className="flex flex-col gap-3 md:w-2/3 mx-auto">
          {filteredQuestions.map((q, index) => (
            <div key={q.id} className="collapse collapse-arrow shadow-lg">
...
const questions = [
  ...
  },
  {
    ...
    answer: " Necesitas ser miembro: registrarte en la página y escoger uno de los tres Planes (Personalidad, Alma o Espíritu) o iniciar sesión si ya te registraste con uno de los tres Planes para poder disfrutar de los descuentos y/o ofertas."
  },
  {
    id: 3,
  ...
  },
  {
    ...
    answer: "  La sección del Tarot está incluida sólo en los Planes de pago Alma y Espíritu. Si estás en el plan Personalidad o sólo eres miembro de la página no tendrás acceso a este servicio.",
  ...
  },
  {
    ...
    answer: "Debes entrar en el Portal del Cliente en Inicio o en la sección Ayuda. Esto te redireccionará a Stripe, a nuestro sistema de pago y allí podrás modificar todos tus datos personales.",

  },
  {
    id: 8,
    question: "¿Qué significa que mi plan se cancela? 🤔",
    answer: "Qué se paraliza la renovación automática de tu plan en la fecha indicada. Qué se suspenden los pagos o la suscripción gratuita definitivamente y necesitarás suscribirte de nuevo a alguno de los tres planes.",

  },
  {
    id: 9,
    question: "¿Qué significa cero preguntas disponibles? 🤔",
    answer: " Que utilizaste el máximo permitido de preguntas para ese mes. Esto se renovará automáticamente el primer día de cada mes y volverás a disfrutar de nuevo de más preguntas.",
